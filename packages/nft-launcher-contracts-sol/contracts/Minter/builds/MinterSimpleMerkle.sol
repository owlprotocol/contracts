...
contract MinterSimpleMerkle is MinterCore {
     ...
     */
    function mint(uint256 speciesId, uint256 tokenId, bytes32 merkleRoot, bytes32[] calldata merkleProof) public speciesExists(speciesId) mintAllowedMerkle(speciesId, merkleRoot, merkleProof) {
        // Mint Operation
     ...
     * @param tokenId minted token id
     */
    function safeMint(uint256 speciesId, uint256 tokenId, bytes32 merkleRoot, bytes32[] calldata merkleProof) public speciesExists(speciesId) mintAllowedMerkle(speciesId, merkleRoot, merkleProof) {
        // Mint Operation
