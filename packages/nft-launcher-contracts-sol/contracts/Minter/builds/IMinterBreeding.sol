...
interface IMinterBreeding is IMinterCore {
     ...
     */
    function breed(uint256 speciesId, uint256[] calldata parents) external returns (uint256 tokenId);
     ...
     * @return tokenId minted token id
     */
    function safeBreed(uint256 speciesId, uint256[] calldata parents) external returns (uint256 tokenId);
