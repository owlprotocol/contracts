...
interface ERC721MintableCodeInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC721MintableCode extends BaseContract {
  ...
  interface: ERC721MintableCodeInterface;
