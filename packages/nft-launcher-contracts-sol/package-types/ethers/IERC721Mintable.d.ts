...
interface IERC721MintableInterface extends ethers.utils.Interface {
  functions: {
...
export class IERC721Mintable extends BaseContract {
  ...
  callStatic: {
    ...
    grantMinter(a: string, overrides?: CallOverrides): Promise<void>;
