...
interface IMinterSimpleMerkleInterface extends ethers.utils.Interface {
  functions: {
...
export class IMinterSimpleMerkle extends BaseContract {
  ...
  interface: IMinterSimpleMerkleInterface;
