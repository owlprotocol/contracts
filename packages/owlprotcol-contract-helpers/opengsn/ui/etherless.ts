...
// TODO - networks object to configure active networks
...
const conf = {
    ourContract: "0xbB540bd042AcD46bA3443Ab86672bEe8422B4659",
    ...
    gasPrice: 20000000000, //20 Gwei maximum acceptable gas price
};
...
const getGSNProvider = async () => {
    // TODO - pass conf
    // TODO - allow passing custom provider
...
//     if (provider._network.chainId != 4) {
//         alert("I only know the addresses for Rinkeby");
...
//everything below from MetaCoin
let accounts;
let account;
    ...
    start: async function () {
        ...
        web3.eth.net.getId(async function (err, networkId) {
            if (parseInt(networkId) < 1000) {
                ...
                MetaCoin.deployed = () => MetaCoin.at(network.ERC721Owl);
            } else {
                // We're on ganache
