import { encodeGenesUint256, decodeGenesUint256 } from '../utils';
import { BigNumber } from 'ethers';
import { assert, expect } from 'chai';
import { ethers } from 'hardhat';
import { RosalindTestLab__factory, RosalindTestLab } from '../../typechain';
...
describe('RosalindDNA.sol', async () => {
    ...
    before(async () => {
        dnaLibFactory = (await ethers.getContractFactory('RosalindTestLab')) as RosalindTestLab__factory;
    ...
    describe('RosalindDNA.setGenCount(...)', async () => {
        ...
        it('Throw on last generation', async () => {
            ...
            await expect(dnaLib.setGenCount(offspringDNA, [parent1, parent2])).to.be.revertedWith(
