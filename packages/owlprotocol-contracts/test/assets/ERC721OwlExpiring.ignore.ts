...
import { TestEnvironment } from '@opengsn/cli/dist/GsnTestEnvironment';
...
describe.skip('ERC721Expiring.sol', () => {
    ...
    describe('ownerOf()', async () => {
        beforeEach(async () => {
            await expect(contrInst.ownerOf(1)).to.be.revertedWith('ERC721: operator query for nonexistent token');
