...
### __RentableERC721Upgradeable_init

```solidity
function __RentableERC721Upgradeable_init(string name_, string symbol_) internal
```

_Initializes the contract by setting a &#x60;name&#x60; and a &#x60;symbol&#x60; to the token collection._

### __RentableERC721Upgradeable_init_unchained
